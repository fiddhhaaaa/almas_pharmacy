...
# =========================================
# DELETE: Clear All Predictions
# =========================================
@router.delete("/clear/all", status_code=status.HTTP_200_OK)
async def clear_all_predictions(db: Session = Depends(get_db)):
    """
    ...
    if total_predictions == 0:
        raise HTTPException(
            status_code=404, 
            detail="No predictions found to delete"
        )
    ...
    return {
        "message": "Successfully deleted all predictions",
        "deleted_predictions": total_predictions,
        "warning": "All prediction data has been permanently removed"
    }
